...
namespace MVCPagina.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ServicioId,Nombre,Precio,CantidadIconos")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ServicioId,Nombre,Precio,CantidadIconos")] Servicio servicio)
        {
            if (ModelState.IsValid)
            {
